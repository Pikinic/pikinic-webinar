  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-x-hidden">
      ...
      <main className="flex-grow">
        ...
        {/* Hero Section */}
        <section id="hero" className="bg-white pt-12 pb-24 md:py-32 border-b border-teal-900/5 relative">
          {/* Subtle background abstract decorations */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-teal-900/5 rounded-full blur-3xl pointer-events-none -mr-32 -mt-32" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-red-500/5 rounded-full blur-3xl pointer-events-none -ml-32 -mb-32" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-start space-y-8">
                ...
                <Reveal delay={200} duration={600}>
                  <h1 className="text-4xl md:text-5xl lg:text-6.5xl font-bold text-teal-900 tracking-tight leading-[1.02] font-sans">
                ...
                <Reveal delay={500} duration={600}>
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto pt-2">
                    <Link
                      ...
                      className="inline-flex items-center justify-center px-8 py-4 rounded-full text-base font-bold text-white bg-red-500 hover:bg-red-500/95 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-[0_4px_20px_rgba(237,50,55,0.25)] text-center group"
                    >
                      Save My Free Seat
              ...
              {/* Right Column - Premium Generated Image with overlay border */}
              <div className="lg:col-span-5 relative w-full aspect-square md:max-w-md lg:max-w-none mx-auto">
                <Reveal delay={300} duration={800} className="w-full h-full">
                  <div className="absolute inset-0 border border-teal-900/10 rounded-2xl overflow-hidden shadow-2xl bg-teal-900/5 transform hover:scale-[1.01] hover:rotate-1 transition-all duration-500">
                    <Image
                      src="/images/hero_professional.jpg"
                      alt="Nigerian Professional at desk with laptop"
                      fill
        ...
        {/* Trust Bar Section */}
        <section className="bg-white py-12 border-b border-teal-900/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Reveal duration={600}>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-12 divide-y sm:divide-y-0 sm:divide-x divide-teal-900/10 text-center sm:text-left bg-teal-900/5 rounded-2xl p-8 border border-teal-900/5">
                {/* Stat 1 */}
        ...
        <section id="tracks" className="bg-white py-24 md:py-32 border-b border-teal-900/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <Reveal delay={100} className="h-full">
                <div className="relative group flex flex-col h-full bg-white border border-teal-900/10 rounded-3xl shadow-sm hover:shadow-xl hover:border-red-500/30 hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                  {/* Card Image */}
                  ...
                  <div className="p-8 flex flex-col justify-between flex-grow">
                    ...
                    <div className="mt-8 pt-6 border-t border-teal-900/5">
                      <Link
                        ...
                        className="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 rounded-full text-sm font-bold text-white bg-red-500 hover:bg-red-500/90 hover:scale-[1.02] active:scale-[0.98] transition-all group/link"
                      >
              ...
              <Reveal delay={200} className="h-full">
                <div className="relative group flex flex-col h-full bg-white border border-teal-900/10 rounded-3xl shadow-sm hover:shadow-xl hover:border-orange-500/30 hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                  {/* Card Image */}
                  <div className="relative w-full aspect-[16/10] bg-teal-900/5 overflow-hidden">
                    <Image
                  ...
                  <div className="p-8 flex flex-col justify-between flex-grow">
                    ...
                    <div className="mt-8 pt-6 border-t border-teal-900/5">
                      <Link
                        ...
                        className="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 rounded-full text-sm font-bold text-white bg-orange-500 hover:bg-orange-500/90 hover:scale-[1.02] active:scale-[0.98] transition-all group/link"
                      >
        ...
        <section className="bg-white py-24 md:py-32 border-b border-teal-900/5 relative">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <Reveal>
              <div className="bg-gradient-to-br from-teal-900/5 to-teal-900/[0.02] border border-teal-900/10 rounded-3xl p-8 sm:p-12 shadow-sm text-center md:text-left">
        ...
        <section id="how-it-works" className="bg-gradient-to-br from-teal-900 to-ink-900 text-cream-50 py-24 md:py-32 relative">
          <div className="absolute top-0 right-0 w-96 h-96 bg-red-500/[0.03] rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <Reveal delay={200} className="mt-12 text-center">
              <Link
                href="/webinar/register"
                className="inline-flex items-center justify-center px-8 py-4 rounded-full text-base font-bold text-ink-900 bg-yellow-400 hover:bg-yellow-400/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-lg"
              >
        ...
        <section className="bg-white py-24 md:py-32 border-b border-teal-900/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center">
                ...
                <div className="space-y-8">
                  ...
                  <Reveal delay={100}>
                    <div className="flex gap-4 items-start">
                      <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-teal-900/5 flex items-center justify-center text-teal-900 border border-teal-900/10 shadow-sm font-mono font-bold text-sm">
                        01
                      </div>
                      <div>
              ...
              {/* Right Column: Tall Campus Portrait Image */}
              <div className="lg:col-span-5 w-full aspect-[4/5] relative">
                <Reveal delay={200} className="w-full h-full">
                  <div className="absolute inset-0 border border-teal-900/10 rounded-3xl overflow-hidden shadow-2xl bg-teal-900/5">
                    <Image
                  ...
                  {/* Floating badge */}
                  <div className="absolute top-4 right-4 bg-teal-900 text-white font-mono text-[10px] font-bold px-3 py-1.5 rounded-full shadow-md uppercase tracking-wider">
                    Partnership Network
                  </div>
                </Reveal>
              </div>
        ...
        <section className="bg-white py-24 md:py-32 border-b border-teal-900/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 max-w-5xl mx-auto">
              ...
              {/* Speaker 1 */}
              <Reveal delay={100}>
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 bg-teal-900/5 p-6 rounded-2xl border border-teal-900/5 hover:border-teal-900/10 transition-colors h-full">
                  <div className="relative w-28 h-28 sm:w-32 sm:h-32 flex-shrink-0 rounded-2xl overflow-hidden border-2 border-teal-900/20 bg-teal-900/5 shadow-md">
                    <Image
              ...
              <Reveal delay={200}>
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 bg-teal-900/5 p-6 rounded-2xl border border-teal-900/5 hover:border-teal-900/10 transition-colors h-full">
                  <div className="relative w-28 h-28 sm:w-32 sm:h-32 flex-shrink-0 rounded-2xl overflow-hidden border-2 border-orange-500/20 bg-teal-900/5 shadow-md">
                    <Image
        ...
        <section className="bg-gradient-to-br from-teal-900 to-ink-900 text-cream-50 py-24 md:py-32 relative">
          <div className="absolute top-1/2 left-0 w-96 h-96 bg-teal-950/20 rounded-full blur-3xl pointer-events-none -ml-48" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {/* Quote 1 */}
              <Reveal delay={100} className="h-full">
                <div className="p-8 bg-ink-900/50 rounded-3xl border border-teal-900/30 flex flex-col justify-between h-full relative group hover:border-teal-900/60 hover:bg-ink-900/70 transition-all">
                  {/* Quote icon decoration */}
                  <span className="text-6xl text-teal-900/35 font-serif absolute top-4 right-6 select-none pointer-events-none">&ldquo;</span>
        ...
        {/* FAQ Section */}
        <section id="faq" className="bg-white py-24 md:py-32 border-b border-teal-900/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Reveal className="max-w-3xl mx-auto text-center mb-16">
              <span className="text-xs font-mono tracking-widest text-teal-900/60 uppercase">
        ...
        <section className="bg-gradient-to-br from-teal-900 via-teal-950 to-ink-900 text-cream-50 py-24 md:py-32 relative">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,202,6,0.03),transparent)] pointer-events-none" />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center space-y-8 relative z-10">
            ...
            <Reveal delay={200}>
              <div>
                <Link
                  href="/webinar/register"
                  className="inline-flex items-center justify-center px-10 py-5 rounded-full text-base font-bold text-ink-900 bg-yellow-400 hover:bg-yellow-400/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-[0_10px_30px_rgba(255,202,6,0.2)]"
                >
